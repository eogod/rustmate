    ...
    pub fn builtin() -> Self {
        let mut profiles = vec![
            ServiceProfile {
                ...
                services: vec!["http".to_owned(), "http2".to_owned()],
            ...
            ServiceProfile {
                ...
                enabled: true,
                protocol: None,
                services: vec!["dns".to_owned(), "mdns".to_owned(), "llmnr".to_owned()],
                ports: vec![53, 5353, 5355],
                content_kind: None,
                pattern_ids: Vec::new(),
                default_direction: Some(FlowDirection::AToB),
                default_mode: Some(StreamSliceMode::Hex),
            ...
            ServiceProfile {
                ...
                enabled: true,
                protocol: Some(TransportProtocol::Tcp),
                services: vec!["websocket".to_owned(), "http".to_owned()],
                ports: vec![80, 8000, 8008, 8080, 8081, 8888],
                content_kind: None,
                pattern_ids: Vec::new(),
                default_direction: Some(FlowDirection::AToB),
